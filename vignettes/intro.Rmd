...
library(RMySQL)
# must have pre-existing database "airlines"
db <- src_mysql(host = "localhost", user = "mysql", password = "mysql", dbname = "airlines")
etl_airlines <- etl::etl_connect("airlines", db, dir = "~/dumps/airlines")
etl_update(etl_airlines, year = 2013, month = 9)
```
